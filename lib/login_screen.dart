...
class _loginScreenState extends State<loginScreen> {
      ...
      body: Stack(
        children: [
          ...
          AnimatedPositioned(
            ...
            left: isRegDialogOpen ? -MediaQuery.of(context).size.width : 0,
                          ...
                          children: [
                            ...
                            Center(
                              child: GestureDetector(
                                onTap: () {
                                  setState(() {
                                    isRegDialogOpen = true;
                                  });
                                  showInputTeamKey(context, isLightTheme);
                                },
                                child: Text(
  ...
  Future<Object?> showInputTeamKey(BuildContext context, bool isLightTheme) {
    return showGeneralDialog(
        barrierColor: Colors.transparent,
        transitionDuration: const Duration(milliseconds: animateDuration),
        transitionBuilder: (context, animation, secondaryAnimation, child) {
          Tween<Offset> tweenIn =
              Tween<Offset>(begin: const Offset(1, 0), end: const Offset(0, 0));
          Tween<Offset> tweenOut = Tween<Offset>(
        ...
        context: context,
        pageBuilder: (context, aniamition, secondaryAnimation) => Scaffold(
                                  ...
                                  TextField(
                                    decoration: InputDecoration(
                                      ...
                                      fillColor: isLightTheme
                                          ...
                                          : const Color.fromARGB(100, 20, 2, 9),
                                      hintText:
                                          AppLocalizations.of(context)!.teamKey,
  ...
  Future<Object?> showRegisterScreen(BuildContext context, bool isLightTheme,
    ...
    return showGeneralDialog(
        ...
        context: context,
        pageBuilder: (context, aniamition, secondaryAnimation) => SafeArea(
              minimum: EdgeInsets.fromLTRB(
                  MediaQuery.of(context).size.width / 15,
                  MediaQuery.of(context).size.height / 20,
                  MediaQuery.of(context).size.width / 15,
